...
import {
  getPodcastsActionCreator,
  getLastTimeRequestedActionCreator,
  setLastTimeRequestedActionCreator,
} from "../../store/PodcastActions";
const HomeLayout = () => {
  ...
  useEffect(() => {
    let storageList = JSON.parse(localStorage.getItem("podcastsList"));
    if (lasTimeRequested) {
      setRefresStorage(
        hasPassed24Hours(lasTimeRequested) || storageList == null
      );
    }
  }, [lasTimeRequested]);
